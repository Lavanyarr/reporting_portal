...
class TestObservation:
    ...
    def test_get_observations_in_desc_when_sort_field_is_reported_by(self, snapshot):
        # arrange
        ...
        # act
        response = storage.get_my_observation_in_dec_when_given_sort_field_is_reported_on(observation_dto)
