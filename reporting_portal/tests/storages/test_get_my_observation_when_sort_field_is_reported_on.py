...
class TestObservation:
    ...
    def test_get_observations_when_sort_field_is_due_date(self, snapshot):
        # arrange
        ...
        # act
        response = storage.get_my_observation_when_given_sort_field_is_due_date(observation_dto)
